...
const FloatingActions = () => {
  return (
    <div className="floating-actions-container">
      {/* Call Now */}
      <a href={TEL_URL} className="floating-btn floating-btn-call" id="float-call-btn">
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" width="16" height="16" className="floating-icon">
        ...
        <span className="floating-btn-text">Call Now</span>
      </a>

      {/* WhatsApp */}
      <a href={WA_URL} target="_blank" rel="noopener noreferrer" className="floating-btn floating-btn-wa" id="float-wa-btn">
        <svg viewBox="0 0 24 24" fill="currentColor" width="16" height="16" className="floating-icon">
