        ...
        <div className="footer-grid">
          ...
          <div className="footer-col">
            ...
            <ul style={{ listStyle: 'none', padding: 0, margin: 0, display: 'flex', flexDirection: 'column', gap: '12px' }}>
              ...
              <li style={{ display: 'flex', alignItems: 'center', gap: '8px', color: '#e5e0d8', fontSize: '0.9rem' }}>
                <span style={{ fontSize: '0.6rem', color: '#cba153' }}>●</span>
                <a href="https://wa.me/08977640073" target="_blank" rel="noopener noreferrer" style={{ color: '#e5e0d8', textDecoration: 'none' }}>Bulk/Customized Orders</a>
              </li>
              <li style={{ display: 'flex', alignItems: 'center', gap: '8px', color: '#e5e0d8', fontSize: '0.9rem' }}>
                <span style={{ fontSize: '0.6rem', color: '#cba153' }}>●</span>
          ...
          <div className="footer-col">
            ...
            <ul style={{ listStyle: 'none', padding: 0, margin: 0, display: 'flex', flexDirection: 'column', gap: '12px' }}>
              <li style={{ display: 'flex', alignItems: 'center', gap: '8px', color: '#e5e0d8', fontSize: '0.9rem' }}>
                <span style={{ fontSize: '0.6rem', color: '#cba153' }}>●</span>
                <a href="https://shop.hinaazdesigner.com/account" target="_blank" rel="noopener noreferrer" style={{ color: '#e5e0d8', textDecoration: 'none' }}>My account</a>
              </li>
              <li style={{ display: 'flex', alignItems: 'center', gap: '8px', color: '#e5e0d8', fontSize: '0.9rem' }}>
                <span style={{ fontSize: '0.6rem', color: '#cba153' }}>●</span>
                <a href="https://shop.hinaazdesigner.com/cart" target="_blank" rel="noopener noreferrer" style={{ color: '#e5e0d8', textDecoration: 'none' }}>Cart</a>
              </li>
              <li style={{ display: 'flex', alignItems: 'center', gap: '8px', color: '#e5e0d8', fontSize: '0.9rem' }}>
                <span style={{ fontSize: '0.6rem', color: '#cba153' }}>●</span>
